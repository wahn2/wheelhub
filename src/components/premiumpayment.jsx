...
const Makepaymentnow = ()=> {
    ...
    const img_url = "https://mumo2007.pythonanywhere.com/static/images/"
    ...
    const submit = async(e) =>{
     ...
     setMessage("Please wait as we Processs!");
      ...
      const response = await axios.post(
        "https://joshua254.pythonanywhere.com/api/mpesa_payment",
        data
      );
                ...
                <form onSubmit={submit}>
                    ...
                    <div className="d-grid gap-2">
                        <button type="submit" className="btn btn-primary btn-lg">
                            <i className="bi bi-cash me-2"></i>Make Deposit
                        </button>
                    </div>
                </form>
            </div>
